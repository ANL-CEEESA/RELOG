...
| `minimum demand (tonne)`       | Minimum amount of the input product that must be sent to this center per year. Must be a time series. Only valid when input is not null.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `maximum demand (tonne)`       | Maximum amount of the input product that must be sent to this center per year. Must be a time series. Only valid when input is not null.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
